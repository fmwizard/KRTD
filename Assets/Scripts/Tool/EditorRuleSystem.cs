...
public class EditorRuleSystem
{
    ...
    public EditorRuleSystem(int boardSize, int winCondition)
    {
        this.boardSize = boardSize;
        this.winCondition = Mathf.Min(boardSize, winCondition);
    }

    public bool CheckWinCondition(EditorBoard board, CellMark playerMark)
    {
        // Check rows
    ...
    private bool CheckRow(EditorBoard board, int row, CellMark playerMark)
    {
        int count = 0;
        for (int col = 0; col < boardSize; col++)
        {
    ...
    private bool CheckColumn(EditorBoard board, int col, CellMark playerMark)
    {
        int count = 0;
        for (int row = 0; row < boardSize; row++)
        {
    ...
    private bool CheckDiagonal(EditorBoard board, CellMark playerMark)
    {
    ...
    private bool CheckAntiDiagonal(EditorBoard board, CellMark playerMark)
    {
        for (int sRow = 0; sRow <= boardSize - winCondition; sRow++)
        {
